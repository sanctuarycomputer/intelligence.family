...
| `RESEND_FROM` | Sender, e.g. `Family Intelligence <invest@intelligence.family>` |
| `REPLY_TO` | Reply-to address, e.g. `invest@intelligence.family` (optional; omitted from the send when unset) |
