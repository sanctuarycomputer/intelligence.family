...
const LEAF_PAGES = [1, 7, 13, 18, TOTAL + 1]; // cover + act splashes + appendix splash

export const PAGE_META: PageMeta[] = [
  ...actRun(7, 'I · The Category', 1),
  ...actRun(5, 'II · Our First Device', 8),
  ...actRun(5, 'III · Under the Hood', 13, true),
  ...actRun(5, 'IV · The Ask', 18),
  ...APPENDIX_META,
];
