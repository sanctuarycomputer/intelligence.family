...
export default function Home() {
  return (
    <>
      <main className="min-h-screen px-6 py-24 md:px-20 md:py-32">
        <div className="max-w-[620px]">
          ...
          <div className="mt-4">
            <p>
              ...
              American households owned a computer in 1984, and 89% did by 2016.
              The datacenter is making the same move.
            </p>
            ...
            <p>
              ...
              encryption patterns give private cloud-level convenience. A local
              MCP server and on-device agent offer general intelligence to every
            ...
            <p>
              ...
              families feel safe using them. Your family&rsquo;s health history,
              your finances, your will, your kids&rsquo; school calendar, your
              grandmother&rsquo;s voice. All precious data you&rsquo;d never
              upload to cloud AI. Exactly what an agentic home assistant needs
              to be helpful.
            </p>
            ...
            <p>
              ...
              taking orders. If you can help us hone our vision, write and tell
              us how.
            </p>
          </div>
